...
<div class="flex min-h-screen">
    ...
    <aside class="w-60 bg-white border-r border-gray-200 flex flex-col px-4 py-6">
        ...
        <nav class="flex flex-col gap-3">
            <a href="/homepageadmin" class="flex items-center gap-2 px-3 py-2 rounded-full bg-blue-900 text-white">
            ...
            <a href="/managementadmin" class="flex items-center gap-2 px-3 py-2 rounded-full hover:bg-gray-100">
                <img src="/mnt/data/eca25925-1e87-48f2-b108-44483cf14fc1.png" class="w-5 h-5" alt="icon library">
                Management
            </a>
        </nav>
